...
| 11 | Eclipse Project for JMS | Eclipse Proeject for JMS provides the API and TCK for Java™ Message Service (JMS) API, starting from the specification defined by JSR-343. | Java Message Service API 2.0 | JSR 343 |
